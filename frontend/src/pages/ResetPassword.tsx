...
const ResetPassword: React.FC = () => {
  ...
  return (
    <div className="min-h-screen flex items-center justify-center bg-gray-100 px-4">
      <form onSubmit={handleResetPassword} className="w-full max-w-md p-8 bg-white border rounded-lg shadow-md space-y-4" dir="rtl">
        ...
        <div className="flex gap-4">
          <button
            type="submit"
            disabled={loading}
            className={`w-full bg-black text-white p-2 rounded ${loading ? 'opacity-50 cursor-not-allowed' : 'hover:bg-orange-500'} transition-colors`}
          >
